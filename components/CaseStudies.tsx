  ...
  return (
    <Section id={SectionId.CaseStudies} className="bg-white">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        <div className="bg-[#FAFAFA] rounded-3xl p-8 border border-gray-100 relative group hover:shadow-xl transition-all duration-300">
          ...
          <div className="flex gap-2 mb-6">
            <span className="bg-white border border-gray-200 px-3 py-1 rounded-full text-xs font-bold text-gray-500 uppercase tracking-wide">Temps</span>
          </div>
          <h3 className="text-3xl font-black text-[#2A4EFA] mb-2">+22% CA</h3>
          ...
          <div className="flex items-center gap-4 border-t border-gray-200 pt-6">
            ...
            <div>
              <div className="font-bold text-[#111A4D]">Jean Dubois</div>
              <div className="text-sm text-gray-500">Fondateur, <span className="text-[#2A4EFA] font-bold">Maison Dubois</span></div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#FAFAFA] rounded-3xl p-8 border border-gray-100 relative group hover:shadow-xl transition-all duration-300">
          <Quote className="absolute top-8 right-8 w-12 h-12 text-[#E5E7EB] fill-[#E5E7EB]" />
          <div className="flex gap-2 mb-6">
            <span className="bg-white border border-gray-200 px-3 py-1 rounded-full text-xs font-bold text-gray-500 uppercase tracking-wide">Productivité</span>
          </div>
          <h3 className="text-3xl font-black text-[#2A4EFA] mb-2">x3 Leads</h3>
          ...
          <div className="flex items-center gap-4 border-t border-gray-200 pt-6">
            ...
            <div>
              <div className="font-bold text-[#111A4D]">Sarah L.</div>
              <div className="text-sm text-gray-500">Dir. Associée, <span className="text-[#2A4EFA] font-bold">LegalTech Sud</span></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-16 bg-[#111A4D] rounded-3xl p-8 md:p-12 text-white grid md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-white/10">
        <div><div className="text-4xl font-black font-heading mb-2 text-[#C1F4D8]">100%</div><div className="text-blue-200 font-bold">Projets livrés</div></div>
        <div><div className="text-4xl font-black font-heading mb-2 text-[#C1F4D8]">x4</div><div className="text-blue-200 font-bold">ROI Moyen</div></div>
        <div><div className="text-4xl font-black font-heading mb-2 text-[#C1F4D8]">24h</div><div className="text-blue-200 font-bold">Délai Audit</div></div>
      </div>
    </Section>
  );
};