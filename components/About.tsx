  ...
  return (
    <Section id={SectionId.About} className="bg-gradient-to-b from-white to-[#F0F7FF] px-4">
      <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
        <div>
          <span className="text-[#2A4EFA] font-black tracking-[0.2em] uppercase text-xs mb-4 block">Notre Mission</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-8">
            <div className="space-y-3">
              ...
              <h4 className="font-black text-[#111A4D] uppercase text-[10px] tracking-widest">Temps Libéré</h4>
            ...
            <div className="space-y-3">
              ...
              <h4 className="font-black text-[#111A4D] uppercase text-[10px] tracking-widest">Accompagnement</h4>
            ...
            <div className="space-y-3">
              ...
              <h4 className="font-black text-[#111A4D] uppercase text-[10px] tracking-widest">Sur Mesure</h4>
        ...
        <div className="relative group mt-10 lg:mt-0">
          ...
          <div className="absolute -bottom-6 -left-4 md:-bottom-10 md:-left-10 glass-card p-6 md:p-10 rounded-[1.5rem] md:rounded-[2.5rem] shadow-2xl max-w-[220px] md:max-w-xs z-20 border border-white/60 animate-float">
            <p className="text-[#111A4D] font-black text-lg md:text-2xl mb-1 md:mb-2 leading-tight">"Récupérez vos vendredis grâce à l'IA."</p>
            <p className="text-[#2A4EFA] font-bold text-[10px] md:text-sm tracking-widest uppercase">— Stratégie Axia</p>
          </div>
        </div>
      </div>
    </Section>
